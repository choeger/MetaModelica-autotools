...
/* adrpo added 2004-12-06 after running /config/tools/repchk again */
/* also should be noted that repchk said: 
   repchk error: function addresses are not at least evenly aligned 
   probably we should look into this!!! */
/* fixed it already, needed gcc -O2 to -falign-functions */
#define RML_DBL_PAD
